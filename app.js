let playlist = [
  {
    ...
    audio: 'assets/music/M.2.mp3',
    img: document.getElementById('track_image').src = "img1.jpg",
   
  
},
  { 
    title: 'Tarabin Taraba',
    audio: 'assets/music/M.1.mp3',
    img: document.getElementById('track_image').src = "img2.jpg",
    
  },
  {
    title: 'Go Bears',
  audio: "assets/music/M.3.mp3",
  img: document.getElementById('track_image').src = "img3.jpg",
  }
